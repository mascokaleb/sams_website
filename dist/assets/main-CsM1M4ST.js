import{f as Oe,p as I}from"./sanityClient-DVNU9G8W.js";/* empty css               */function F(e){return e._type==="span"&&"text"in e&&typeof e.text=="string"&&(typeof e.marks>"u"||Array.isArray(e.marks)&&e.marks.every(t=>typeof t=="string"))}function be(e){return typeof e._type=="string"&&e._type[0]!=="@"&&(!("markDefs"in e)||!e.markDefs||Array.isArray(e.markDefs)&&e.markDefs.every(t=>typeof t._key=="string"))&&"children"in e&&Array.isArray(e.children)&&e.children.every(t=>typeof t=="object"&&"_type"in t)}function $e(e){return be(e)&&"listItem"in e&&typeof e.listItem=="string"&&(typeof e.level>"u"||typeof e.level=="number")}function ve(e){return e._type==="@list"}function ke(e){return e._type==="@span"}function Le(e){return e._type==="@text"}const oe=["strong","em","code","underline","strike-through"];function je(e,t,n){if(!F(e)||!e.marks)return[];if(!e.marks.length)return[];const a=e.marks.slice(),r={};return a.forEach(i=>{r[i]=1;for(let o=t+1;o<n.length;o++){const l=n[o];if(l&&F(l)&&Array.isArray(l.marks)&&l.marks.indexOf(i)!==-1)r[i]++;else break}}),a.sort((i,o)=>Ue(r,i,o))}function Ue(e,t,n){const a=e[t],r=e[n];if(a!==r)return r-a;const i=oe.indexOf(t),o=oe.indexOf(n);return i!==o?i-o:t.localeCompare(n)}function qe(e){var o;const{children:t}=e,n=e.markDefs??[];if(!t||!t.length)return[];const a=t.map(je),r={_type:"@span",children:[],markType:"<unknown>"};let i=[r];for(let l=0;l<t.length;l++){const d=t[l];if(!d)continue;const c=a[l]||[];let u=1;if(i.length>1)for(u;u<i.length;u++){const h=((o=i[u])==null?void 0:o.markKey)||"",g=c.indexOf(h);if(g===-1)break;c.splice(g,1)}i=i.slice(0,u);let f=i[i.length-1];if(f){for(const h of c){const g=n==null?void 0:n.find(L=>L._key===h),b=g?g._type:h,m={_type:"@span",_key:d._key,children:[],markDef:g,markType:b,markKey:h};f.children.push(m),i.push(m),f=m}if(F(d)){const h=d.text.split(`
`);for(let g=h.length;g-- >1;)h.splice(g,0,`
`);f.children=f.children.concat(h.map(g=>({_type:"@text",text:g})))}else f.children=f.children.concat(d)}}return r.children}function Re(e,t){const n=[];let a;for(let r=0;r<e.length;r++){const i=e[r];if(i){if(!$e(i)){n.push(i),a=void 0;continue}if(!a){a=R(i,r,t),n.push(a);continue}if(Ye(i,a)){a.children.push(i);continue}if((i.level||1)>a.level){const o=R(i,r,t);{const l=a.children[a.children.length-1],d={...l,children:[...l.children,o]};a.children[a.children.length-1]=d}a=o;continue}if((i.level||1)<a.level){const o=n[n.length-1],l=o&&te(o,i);if(l){a=l,a.children.push(i);continue}a=R(i,r,t),n.push(a);continue}if(i.listItem!==a.listItem){const o=n[n.length-1],l=o&&te(o,{level:i.level||1});if(l&&l.listItem===i.listItem){a=l,a.children.push(i);continue}else{a=R(i,r,t),n.push(a);continue}}console.warn("Unknown state encountered for block",i),n.push(i)}}return n}function Ye(e,t){return(e.level||1)===t.level&&e.listItem===t.listItem}function R(e,t,n){return{_type:"@list",_key:`${e._key||`${t}`}-parent`,mode:n,level:e.level||1,listItem:e.listItem,children:[e]}}function te(e,t){const n=t.level||1,a=t.listItem||"normal",r=typeof t.listItem=="string";if(ve(e)&&(e.level||1)===n&&r&&(e.listItem||"normal")===a)return e;if(!("children"in e))return;const i=e.children[e.children.length-1];return i&&!F(i)?te(i,t):void 0}function Te(e){let t="";return e.children.forEach(n=>{Le(n)?t+=n.text:ke(n)&&(t+=Te(n))}),t}const Fe=["http","https","mailto","tel"],Ve={"&":"amp","<":"lt",">":"gt",'"':"quot","'":"#x27"};function Ae(e){return Ge(e.replace(/[&<>"']/g,t=>`&${Ve[t]};`))}function Ge(e){return e.replace(/ {2,}/g,t=>`${"&nbsp;".repeat(t.length-1)} `)}function We(e){const t=(e||"").trim(),n=t.charAt(0);if(n==="#"||n==="/")return!0;const a=t.indexOf(":");if(a===-1)return!0;const r=t.slice(0,a).toLowerCase();if(Fe.indexOf(r)!==-1)return!0;const i=t.indexOf("?");if(i!==-1&&a>i)return!0;const o=t.indexOf("#");return o!==-1&&a>o}const ze={number:({children:e})=>`<ol>${e}</ol>`,bullet:({children:e})=>`<ul>${e}</ul>`},Ke=({children:e})=>`<li>${e}</li>`,Ze=({children:e,value:t})=>{const n=(t==null?void 0:t.href)||"";return We(n)?`<a href="${Ae(n)}">${e}</a>`:e},Qe={em:({children:e})=>`<em>${e}</em>`,strong:({children:e})=>`<strong>${e}</strong>`,code:({children:e})=>`<code>${e}</code>`,underline:({children:e})=>`<span style="text-decoration:underline">${e}</span>`,"strike-through":({children:e})=>`<del>${e}</del>`,link:Ze},q=(e,t)=>`Unknown ${e}, specify a component for it in the \`components.${t}\` option`,Se=e=>q(`block type "${e}"`,"types"),Xe=e=>q(`mark type "${e}"`,"marks"),Je=e=>q(`block style "${e}"`,"block"),et=e=>q(`list style "${e}"`,"list"),tt=e=>q(`list item style "${e}"`,"listItem");function nt(e){console.warn(e)}const at=({value:e,isInline:t})=>{const n=Se(e._type);return t?`<span style="display:none">${n}</span>`:`<div style="display:none">${n}</div>`},rt=({markType:e,children:t})=>`<span class="unknown__pt__mark__${e}">${t}</span>`,it=({children:e})=>`<p>${e}</p>`,st=({children:e})=>`<ul>${e}</ul>`,lt=({children:e})=>`<li>${e}</li>`,ot=()=>"<br/>",ct={normal:({children:e})=>`<p>${e}</p>`,blockquote:({children:e})=>`<blockquote>${e}</blockquote>`,h1:({children:e})=>`<h1>${e}</h1>`,h2:({children:e})=>`<h2>${e}</h2>`,h3:({children:e})=>`<h3>${e}</h3>`,h4:({children:e})=>`<h4>${e}</h4>`,h5:({children:e})=>`<h5>${e}</h5>`,h6:({children:e})=>`<h6>${e}</h6>`},ce={types:{},block:ct,marks:Qe,list:ze,listItem:Ke,hardBreak:ot,escapeHTML:Ae,unknownType:at,unknownMark:rt,unknownList:st,unknownListItem:lt,unknownBlockStyle:it};function dt(e,t){const{block:n,list:a,listItem:r,marks:i,types:o,...l}=t;return{...e,block:j(e,t,"block"),list:j(e,t,"list"),listItem:j(e,t,"listItem"),marks:j(e,t,"marks"),types:j(e,t,"types"),...l}}function j(e,t,n){const a=t[n],r=e[n];return typeof a=="function"||a&&typeof r=="function"?a:a?{...r,...a}:r}function ut(e,t={}){const{components:n,onMissingComponent:a=nt}=t,r=a||gt,i=Array.isArray(e)?e:[e],o=Re(i,"html"),l=n?dt(ce,n):ce,d=ft(l,r);return o.map((c,u)=>d({node:c,index:u,isInline:!1,renderNode:d})).join("")}const ft=(e,t)=>{function n(c){const{node:u,index:f,isInline:h}=c;return ve(u)?r(u,f):$e(u)?a(u,f):ke(u)?i(u):be(u)?o(u,f,h):Le(u)?l(u):d(u,f,h)}function a(c,u){const f=de({node:c,index:u,isInline:!1,renderNode:n}),h=e.listItem,g=(typeof h=="function"?h:h[c.listItem])||e.unknownListItem;if(g===e.unknownListItem){const m=c.listItem||"bullet";t(tt(m),{type:m,nodeType:"listItemStyle"})}let b=f.children;if(c.style&&c.style!=="normal"){const{listItem:m,...L}=c;b=n({node:L,index:u,isInline:!1})}return g({value:c,index:u,isInline:!1,renderNode:n,children:b})}function r(c,u){const f=c.children.map((b,m)=>n({node:b._key?b:{...b,_key:`li-${u}-${m}`},index:m,isInline:!1})),h=e.list,g=(typeof h=="function"?h:h[c.listItem])||e.unknownList;if(g===e.unknownList){const b=c.listItem||"bullet";t(et(b),{nodeType:"listStyle",type:b})}return g({value:c,index:u,isInline:!1,renderNode:n,children:f.join("")})}function i(c){const{markDef:u,markType:f,markKey:h}=c,g=e.marks[f]||e.unknownMark,b=c.children.map((m,L)=>n({node:m,index:L,isInline:!0}));return g===e.unknownMark&&t(Xe(f),{nodeType:"mark",type:f}),g({text:Te(c),value:u,markType:f,markKey:h,renderNode:n,children:b.join("")})}function o(c,u,f){const{_key:h,...g}=de({node:c,index:u,isInline:f,renderNode:n}),b=g.node.style||"normal",m=(typeof e.block=="function"?e.block:e.block[b])||e.unknownBlockStyle;return m===e.unknownBlockStyle&&t(Je(b),{nodeType:"blockStyle",type:b}),m({...g,value:g.node,renderNode:n})}function l(c){if(c.text===`
`){const u=e.hardBreak;return u?u():`
`}return e.escapeHTML(c.text)}function d(c,u,f){const h=e.types[c._type];return h||t(Se(c._type),{nodeType:"block",type:c._type}),(h||e.unknownType)({value:c,isInline:f,index:u,renderNode:n})}return n};function de(e){const{node:t,index:n,isInline:a,renderNode:r}=e,i=qe(t).map((o,l)=>r({node:o,isInline:!0,index:l,renderNode:r}));return{_key:t._key||`block-${n}`,children:i.join(""),index:n,isInline:a,node:t}}function gt(){}const W="images/samuel-placeholder.svg",we=W,Y=/^[a-zA-Z0-9_-]{11}$/,v={heroCopy:'[data-template="hero-copy"]',heroPhoto:'[data-template="hero-photo"]',accoladesMarquee:'[data-template="accolades-marquee"]',workInterstitial:'[data-template="work-interstitial"]',workMindset:'[data-template="work-mindset"]',coachSnapshot:'[data-template="coach-snapshot"]',aboutHeading:'[data-template="about-heading"]',aboutGrid:'[data-template="about-grid"]',resumeHeading:'[data-template="resume-heading"]',resumePanels:'[data-template="resume-panels"]',academicsHeading:'[data-template="academics-heading"]',academicsGrid:'[data-template="academics-grid"]',highlightsHeading:'[data-template="highlights-heading"]',highlightsTimeline:'[data-template="timeline"]',upcomingHeading:'[data-template="upcoming-heading"]',upcomingGrid:'[data-template="upcoming-grid"]',videosHeading:'[data-template="videos-heading"]',videoGrid:'[data-template="video-grid"]',videosActions:'[data-template="videos-actions"]',galleryHeading:'[data-template="gallery-heading"]',galleryGrid:'[data-template="gallery-grid"]',galleryActions:'[data-template="gallery-actions"]',dualHeading:'[data-template="dual-heading"]',dualGrid:'[data-template="dual-grid"]',contactHeading:'[data-template="contact-heading"]',contactGrid:'[data-template="contact-grid"]',highlightsActions:'[data-template="highlights-actions"]'},C={meta:null,allItems:[],items:[],videos:[],photos:[]},U={meta:null,items:[],totalCount:0},V={meta:null,items:[]};document.addEventListener("DOMContentLoaded",async()=>{mt(),wn();const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;await ht(),window.location.hash&&setTimeout(()=>Be(window.location.hash),100),Dn(e),Nn(e),Bn()});function mt(){const e=document.querySelector(".nav-toggle"),t=document.querySelector(".nav-links");!e||!t||(e.addEventListener("click",()=>{const n=e.getAttribute("aria-expanded")==="true"?"false":"true";e.setAttribute("aria-expanded",n),t.classList.toggle("is-open")}),t.querySelectorAll("a").forEach(n=>{n.addEventListener("click",()=>{e.setAttribute("aria-expanded","false"),t.classList.remove("is-open")})}))}async function ht(){Z(!0);const e=await Oe();if(!e)return Sn("Unable to load the latest content. Please try again shortly."),Z(!1),null;pt(e.site),yt(e.hero,e.site),bt(e.resume,e.hero),At(e.coachSnapshot,{hero:e.hero,about:e.about}),wt(e.about,{academics:e.academics}),kt(e.about,e.highlightEvents),Mt(e.resume),Ot(e.academics);const t=Q(e.highlightEvents||[]),{past:n,future:a}=Pn(t);C.meta=e.highlightsSection,C.allItems=n,C.items=n.filter(X),jt();const r=Array.isArray(e.upcomingTournaments)?e.upcomingTournaments:[],i=xn(r,a);Ct(e.upcomingTournamentsSection,i);const o=Q(e.videos||[],"eventDate");C.videos=o,U.meta=e.videosSection,U.items=o.filter(X),U.totalCount=o.length,Ut();const l=Q(e.galleryPhotos||[],"shotDate");return C.photos=l,V.meta=e.gallerySection,V.items=l.filter(X),qt(),Yt(e.dualSport),Ft(e.contact),Vt(e.footer,e.contact),Z(!1),ie(),e}function pt(e){var a;if(!e)return;if(e.siteTitle){document.title=e.siteTitle;const r=document.querySelector(".brand-text");r&&(r.textContent=e.siteTitle)}const t=document.querySelector('meta[name="description"]');t&&e.seoDescription&&t.setAttribute("content",e.seoDescription);const n=document.querySelector(".brand-mark");if(n)if((a=e.brandMarkImage)!=null&&a.url){const r=B(e.brandMarkImage.focalPoint||e.brandMarkImage.hotspot),i=r?` style="object-position: ${y(r)};"`:"";n.innerHTML=`<span class="brand-mark-image"><img src="${y(e.brandMarkImage.url)}" alt="${s(e.brandMarkImage.alt||e.siteTitle||"Site logo")}" loading="lazy"${i} /></span>`,n.classList.add("has-image")}else{const r=e.brandMarkInitials||Mn(e.siteTitle)||n.textContent||"SM";n.textContent=r,n.classList.remove("has-image")}}function yt(e,t){var r,i,o,l;const n=k(v.heroCopy),a=k(v.heroPhoto);if(!e){n&&(n.innerHTML=E("Hero content coming soon."));return}if(n){const d=e.tagline?`<p class="hero-tag">${s(e.tagline)}</p>`:"",c=e.bio?`<p>${s(e.bio)}</p>`:"",u=[he(e.primaryCta,"primary","View Highlights","#highlights"),he(null,"ghost","Schedule a Conversation","#contact")].filter(Boolean).join(""),f=Array.isArray(e.metrics)?e.metrics.filter(g=>g&&(g.label||g.value)).map(g=>{const b=g.value||"",m=String(b).trim().match(/^(-?\d+(?:\.\d+)?)(.*)$/);return`
              <li class="hero-snapshot-item">
                <span class="hero-snapshot-value"${m?` data-counter="${y(m[1])}" data-counter-suffix="${y(m[2]||"")}"`:""}>${s(b)}</span>
    ...
    `}if(a){const d=((r=e.headshot)==null?void 0:r.url)||W,c=((i=e.headshot)==null?void 0:i.alt)||"Portrait of Samuel Masco",u=B(((o=e.headshot)==null?void 0:o.focalPoint)||((l=e.headshot)==null?void 0:l.hotspot)),f=u?` style="object-position: ${y(u)};"`:"";a.innerHTML=`
  ...
  `,n.hidden=!1}function kt(e,t){vt(e,t);const n=k(v.workMindset);if(n){if(!(e!=null&&e.mindsetBody)){n.hidden=!0;return}n.hidden=!1,n.innerHTML=`
    ...
    <div class="work-mindset-body">${z(e.mindsetBody)}</div>
  `}}function Lt(e){if(typeof e!="string")return null;const t=e.match(/^\s*(\d+(?:\.\d+)?)/);return t?t[1]:null}function Tt(e){if(typeof e!="string")return null;const t=e.trim(),n=t.match(/^\s*(\d+)\s*[-–—]\s*(\d+)/);if(n)return`${n[1]}–${n[2]}`;const a=t.match(/^\s*(\d+)/);return a?a[1]:null}function At(e,t={}){const n=k(v.coachSnapshot);if(!n)return;if(!(e&&[e.gpaWeighted,e.satScore,e.actScore,e.ncaaId,e.ncaaStatus,e.transcriptUrl,e.parentName,e.parentEmail,e.parentPhone,e.clubCoachName,e.clubCoachEmail,e.clubCoachPhone,e.hsCoachName,e.hsCoachEmail,e.hsCoachPhone].some(T=>typeof T=="string"&&T.trim()!==""))){n.hidden=!0,n.innerHTML="";return}const r=t.about||{},i=Array.isArray(r.profileFacts)?r.profileFacts:[],o=T=>{var w;return((w=i.find($=>($==null?void 0:$.label)&&T.test($.label)))==null?void 0:w.value)||""},l=o(/graduat/i),d=(e==null?void 0:e.classYear)||(l?`Class of ${l}`:""),c={eyebrow:(e==null?void 0:e.eyebrow)||"Coach Snapshot",heading:(e==null?void 0:e.heading)||"The 30-second read",subheading:(e==null?void 0:e.subheading)||"",classYear:d,gpaWeighted:(e==null?void 0:e.gpaWeighted)||"",sat:(e==null?void 0:e.satScore)||"",act:(e==null?void 0:e.actScore)||"",ncaaId:(e==null?void 0:e.ncaaId)||"",ncaaStatus:(e==null?void 0:e.ncaaStatus)||"",transcriptLabel:(e==null?void 0:e.transcriptLabel)||"Download transcript",transcriptUrl:(e==null?void 0:e.transcriptUrl)||"",parentName:(e==null?void 0:e.parentName)||"",parentRole:(e==null?void 0:e.parentRole)||"",parentEmail:(e==null?void 0:e.parentEmail)||"",parentPhone:(e==null?void 0:e.parentPhone)||"",clubCoachName:(e==null?void 0:e.clubCoachName)||o(/private\s*coach|club\s*coach/i),clubCoachOrg:(e==null?void 0:e.clubCoachOrg)||"",clubCoachEmail:(e==null?void 0:e.clubCoachEmail)||"",clubCoachPhone:(e==null?void 0:e.clubCoachPhone)||"",hsCoachName:(e==null?void 0:e.hsCoachName)||"",hsCoachEmail:(e==null?void 0:e.hsCoachEmail)||"",hsCoachPhone:(e==null?void 0:e.hsCoachPhone)||"",verifiedAt:(e==null?void 0:e.verifiedAt)||o(/verified/i)},u=(T,w,$=!1)=>{if(!w)return"";const S=$?"coach-snapshot-fact-value coach-snapshot-fact-value--mono":"coach-snapshot-fact-value";return`
    ...
    `},f=(T,w,$,S)=>{if(!T&&!$&&!S)return"";const H=w?`<span class="coach-snapshot-contact-role">${s(w)}</span>`:"",P=$?`<a href="tel:${y($.replace(/[^0-9+]/g,""))}">${s($)}</a>`:"",x=S?`<a href="mailto:${y(S)}">${s(S)}</a>`:"",O=[P,x].filter(Boolean).join('<span class="coach-snapshot-contact-divider" aria-hidden="true">·</span>');return`
      <div class="coach-snapshot-contact">
        <div class="coach-snapshot-contact-identity">
          <span class="coach-snapshot-contact-name">${s(T||"")}</span>
          ${H}
        </div>
        ${O?`<div class="coach-snapshot-contact-meta">${O}</div>`:""}
      </div>
    `},h=[u("Class",c.classYear),u("GPA (W)",c.gpaWeighted,!0),u("SAT",c.sat,!0),u("ACT",c.act,!0)].filter(Boolean).join(""),g=[u("NCAA ID",c.ncaaId,!0),u("NCAA Status",c.ncaaStatus),u("Verified",St(c.verifiedAt))].filter(Boolean).join(""),b=c.transcriptUrl?`<a class="btn subtle coach-snapshot-transcript" href="${y(c.transcriptUrl)}" target="_blank" rel="noopener">${s(c.transcriptLabel)}</a>`:"",m=[f(c.parentName,c.parentRole||"Parent / Guardian",c.parentPhone,c.parentEmail),f(c.clubCoachName,c.clubCoachOrg||"Private Coach",c.clubCoachPhone,c.clubCoachEmail),f(c.hsCoachName,"HS Coach",c.hsCoachPhone,c.hsCoachEmail)].filter(Boolean).join(""),L=[h?{title:"By the numbers",body:h}:null,g||b?{title:"Eligibility",body:`${g}${b?`<div class="coach-snapshot-transcript-wrap">${b}</div>`:""}`}:null,m?{title:"Recruiting contacts",body:m}:null].filter(Boolean);if(!L.length){n.hidden=!0;return}const p=`<p class="section-kicker">${s(c.eyebrow)}</p>`,A=`<h2 class="coach-snapshot-heading">${s(c.heading)}</h2>`,M=c.subheading?`<p class="coach-snapshot-subheading">${s(c.subheading)}</p>`:"";n.hidden=!1,n.innerHTML=`
  ...
  `;let l="";if(r){const d=[{label:"School",value:r.schoolCardTitle},{label:"GPA",value:r.gpa},{label:"Honors / AP",value:r.honors},{label:"AP / IB Status",value:r.apCourses}].filter(h=>h.value),c=d.length?`
        ...
        `:"",u=r.interestsBody?`<div class="about-academics-interests">${z(r.interestsBody)}</div>`:"",f=r.transcriptUrl?`<a class="btn subtle" href="${y(r.transcriptUrl)}" target="_blank" rel="noopener">${s(r.transcriptLabel||"Transcript")}</a>`:"";(c||u||f)&&(l=`
  ...
  `}function Mt(e){const t=k(v.resumeHeading),n=k(v.resumePanels);if(t&&(t.innerHTML=e?`
          ...
          <p>${s(e.subheading||"")}</p>
        `:E("Golf resume coming soon.")),n){if(!e){n.innerHTML=E("Resume details coming soon.");return}const a=/^(handicap|gpa)$/i,r=Array.isArray(e.performanceStats)?e.performanceStats:[],i=[],o=[];r.forEach(g=>{Pt(g)?i.push(..._t(g==null?void 0:g.value)):a.test(((g==null?void 0:g.label)||"").trim())||o.push(g)});const l=Array.isArray(e.clubYardages)?e.clubYardages:[],d=l.length?l:i,c=d.length>0,u=e.clubYardagesTitle||"Club Yardages",f=c?`
          <div class="performance-clubs">
            <h4 class="performance-section-title">${s(u)}</h4>
            ${Nt(d)}
          </div>
        `:"",h=o.map(g=>{const b=g.value||"",m=String(b).trim().match(/^(-?\d+(?:\.\d+)?)(.*)$/),L=m?` data-counter="${y(m[1])}" data-counter-suffix="${y(m[2]||"")}"`:"";return`
  ...
  `}function Ct(e,t){const n=k(v.upcomingHeading),a=k(v.upcomingGrid);if(n&&(n.innerHTML=e?`
  ...
  `}function _t(e){return!e||typeof e!="string"?[]:e.split(/[,\n;]/).map(t=>t.trim()).filter(Boolean).map(t=>{const n=t.indexOf(":");if(n>-1)return{club:t.slice(0,n).trim(),yardage:t.slice(n+1).trim()};const a=t.match(/^(.*?)\s+(\d[\d,]*)(\s*(?:yds?|yards?)?)\s*$/i);return a?{club:a[1].trim(),yardage:`${a[2]}${a[3]?a[3].trim():""}`}:{club:t,yardage:""}}).filter(t=>t.club)}function Ot(e){const t=k(v.academicsHeading),n=k(v.academicsGrid);if(t&&(t.innerHTML=e?`
    ...
    `}}function jt(){const e=C.meta,t=C.items||[],n=k(v.highlightsHeading),a=k(v.highlightsTimeline),r=k(v.highlightsActions);if(n&&(n.innerHTML=e?`
    ...
    `)}function Ut(){const e=U.meta,t=U.items||[],n=k(v.videosHeading),a=k(v.videoGrid),r=k(v.videosActions);if(n&&(n.innerHTML=e?`
    ...
    `)}function qt(){const e=V.meta,t=V.items||[],n=k(v.galleryHeading),a=k(v.galleryGrid),r=k(v.galleryActions);if(n){const l=(e==null?void 0:e.heading)||"Photo Gallery",d=(e==null?void 0:e.subheading)||"Tournament action and behind-the-scenes moments.";n.innerHTML=`
      <h2>${s(l)}</h2>
      ${`<p>${s(d)}</p>`}
    `}if(!a)return;const i=Math.max(1,(e==null?void 0:e.maxItems)||6),o=t.slice(0,i);if(!o.length){a.innerHTML=E("Gallery photos coming soon."),r&&(r.innerHTML="");return}if(a.innerHTML=o.map((l,d)=>Rt(l,d)).join(""),a.querySelectorAll("[data-motion]").forEach(l=>l.classList.add("is-visible")),De(a),re(a),r){const l="gallery.html",d=(e==null?void 0:e.ctaLabel)||"Explore the full gallery";r.innerHTML=`<a class="btn ghost" href="${y(l)}">${s(d)}</a>`}}function Rt(e,t=0){var A,M,T,w,$;const n=((A=e==null?void 0:e.image)==null?void 0:A.url)||W,a=((M=e==null?void 0:e.image)==null?void 0:M.alt)||(e==null?void 0:e.title)||"Gallery highlight",r=He(e,{variant:"card"}),i=Hn(e==null?void 0:e.shotDate),o=i?Pe(i):"",l=(T=e==null?void 0:e.image)!=null&&T.url?{src:n,alt:a,title:(e==null?void 0:e.title)||"Gallery highlight"}:null,d=l?`data-photo-src="${y(l.src)}" data-photo-alt="${y(l.alt)}" data-photo-title="${y(l.title)}"`:"",c=[];e!=null&&e.location&&c.push(e.location);const u=c.map(S=>`<span>${s(S)}</span>`).join('<span class="meta-dot" aria-hidden="true">•</span>'),f=u?`<div class="gallery-card-meta">${u}</div>`:"",h=e!=null&&e.description?`<p class="gallery-card-description">${s(e.description)}</p>`:"",g=e!=null&&e.photographer?`<div class="gallery-card-meta gallery-card-meta--secondary">Photo: ${s(e.photographer)}</div>`:"",b=g?`<div class="gallery-card-footer">${g}</div>`:"",m=l?`data-photo-preview="true" ${d}`:"",L=B(((w=e==null?void 0:e.image)==null?void 0:w.focalPoint)||(($=e==null?void 0:e.image)==null?void 0:$.hotspot)),p=L?` style="object-position: ${y(L)};"`:"";return`
  ...
  `:""}function Yt(e){const t=k(v.dualHeading),n=k(v.dualGrid);if(t&&(t.innerHTML=e?`
        ...
        `}).join("")}}function Ft(e){const t=k(v.contactHeading),n=k(v.contactGrid);if(t&&(t.innerHTML=e?`
  ...
  `}function Gt(e){var r;if(!e)return"";const t=e.label?`<strong>${s(e.label)}:</strong> `:"",n=En(e.value),a=(r=e.link)!=null&&r.startsWith("http")?' target="_blank" rel="noopener"':"";return e.link&&n.length<=1?`${t}<a href="${y(e.link)}"${a}>${s(e.value||e.link)}</a>`:n.length?`${t}${n.map((i,o)=>{const l=o===0&&e.link?e.link:i.link;if(l){const c=l.startsWith("http")?' target="_blank" rel="noopener"':"";return`<a href="${y(l)}"${c}>${s(i.text)}</a>`}return s(i.text)}).join(" · ")}`:`${t}${s(e.value||"")}`}function Wt(e,t){var O,le;const n=In(e),a=e.summary?`<p class="case-study-summary">${s(e.summary)}</p>`:"",r=Array.isArray(e.days)?e.days:[],i=`home-highlight-${t}`,o=(e==null?void 0:e._id)||(e==null?void 0:e.title)||i,l=(O=e==null?void 0:e.coverImage)!=null&&O.url?e.coverImage:null,c=(le=Ee(e)[0])==null?void 0:le.image,u=l||c,f=(u==null?void 0:u.url)||"",h=(u==null?void 0:u.alt)||(e==null?void 0:e.title)||"Tournament photo",g=B((u==null?void 0:u.focalPoint)||(u==null?void 0:u.hotspot)),b=g?` style="object-position: ${y(g)};"`:"",m=zt(r),L=(m==null?void 0:m.score)!=null?String(m.score):"",p=(m==null?void 0:m.rank)!=null&&(m==null?void 0:m.rank)!==""?String(m.rank):"",A=(m==null?void 0:m.fieldSize)!=null&&(m==null?void 0:m.fieldSize)!==""?String(m.fieldSize):"",M=(m==null?void 0:m.yardage)!=null&&(m==null?void 0:m.yardage)!==""?String(m.yardage):"",T=e!=null&&e.location?String(e.location):"",w=!!(e!=null&&e.pinToTop||e!=null&&e.featured),$=`
  ...
  `,S=[];if(p){const _e=A?` / ${s(A)}`:"";S.push(`<div class="case-study-chip"><span class="case-study-chip-label">Finish</span><span class="case-study-chip-value">${s(p)}${_e}</span></div>`)}M&&S.push(`<div class="case-study-chip"><span class="case-study-chip-label">Yardage</span><span class="case-study-chip-value">${s(M)}</span></div>`),r.length>1&&S.push(`<div class="case-study-chip"><span class="case-study-chip-label">Rounds</span><span class="case-study-chip-value">${r.length}</span></div>`);const H=S.length?`<div class="case-study-chips">${S.join("")}</div>`:"",P=f?`
        <img
          src="${y(f)}"
          alt="${s(h)}"
          loading="lazy"
          ${b}
        />
      `:`<div class="case-study-media-placeholder" aria-hidden="true"><span>${s(((e==null?void 0:e.title)||"TOUR").slice(0,2).toUpperCase())}</span></div>`,x=String(t+1).padStart(2,"0");return`
    <article class="case-study-card${w?" is-featured":""}" data-motion="delay-${t+1}" data-index="${x}">
      ...
      <div class="case-study-body">
        <div class="case-study-meta">
          <span class="case-study-index">${x}</span>
  ...
  `}function sn(e){const t=Ne(e),n=e.thumbnailUrl||(t?`https://img.youtube.com/vi/${t}/hqdefault.jpg`:we),a=e.thumbnailAlt||e.title||"Video highlight",r=e.title||"Video highlight",o=!!t?"":' disabled aria-disabled="true"',l=ae?ae(e):"",d=B(e.thumbnailFocalPoint||e.thumbnailHotspot),c=d?` style="object-position: ${y(d)};"`:"";return`
  ...
  `}function on(e){var d,c,u,f,h;const t=((d=e==null?void 0:e.image)==null?void 0:d.url)||we,n=((c=e==null?void 0:e.image)==null?void 0:c.alt)||(e==null?void 0:e.title)||"Gallery photo",a=(u=e==null?void 0:e.image)!=null&&u.url?{src:t,alt:n,title:(e==null?void 0:e.title)||"Gallery photo"}:null,r=a?`data-photo-preview="true" data-photo-src="${y(a.src)}" data-photo-alt="${y(a.alt)}" data-photo-title="${y(a.title)}"`:"",i=e!=null&&e.photographer?`<div class="gallery-card-meta gallery-card-meta--secondary">Photo: ${s(e.photographer)}</div>`:"",o=B(((f=e==null?void 0:e.image)==null?void 0:f.focalPoint)||((h=e==null?void 0:e.image)==null?void 0:h.hotspot)),l=o?` style="object-position: ${y(o)};"`:"";return`
  ...
  `}function fn(e){if(!e)return null;const t=I(e);return t?{month:t.toLocaleString("en-US",{month:"short"}),day:t.getDate().toString().padStart(2,"0"),year:t.getFullYear()}:null}function Pe(e){return`
    <div class="video-date-overlay" aria-label="${e.month} ${e.day}, ${e.year}">
      <span class="month">${e.month}</span>
      <strong>${e.day}</strong>
      <span class="year">${e.year}</span>
    </div>
  `}function gn(e){return e?se(e.eventDate,e.endDate,{month:"long"}):""}function mn(e){if(!e)return[];const t=[],n=G(e.score),a=G(e.yardage);t.push(K({key:"score",label:"Score",display:typeof n=="number"?String(n):"—",progress:pn(n)})),t.push(K({key:"yards",label:"Yardage",display:typeof a=="number"?a.toLocaleString():"—",secondary:"",progress:yn(a,hn(e,a))}));const r=$n(e);return t.push(K({key:"rank",label:"Rank",display:r.display,secondary:r.secondary,progress:r.progress})),t.filter(Boolean)}function K({key:e,label:t,display:n,secondary:a,progress:r}){const i=n!=null&&n!==""?String(n):"—",o=a?String(a):"",l=typeof r=="number"&&!Number.isNaN(r)?r:0;return{key:e,label:t,display:i,secondary:o,progress:Math.max(0,l)}}function xe(e,t,n){return e.label?e.label:n>1?`Day ${t+1}`:null}function G(e){return typeof e=="number"&&!Number.isNaN(e)?e:null}function hn(e,t){return typeof t=="number"&&t>0?Math.max(7200,Math.round(t/50)*50):7200}function pn(e){if(typeof e!="number"||Number.isNaN(e))return 0;const t=ue-Zt;return(ue-e)/t}function yn(e,t){return typeof e!="number"||Number.isNaN(e)||!t||t<=0?0:e/t}function bn(e,t){if(typeof e!="number"||Number.isNaN(e)||typeof t!="number"||t<=0)return 0;if(t===1)return 1;const n=(t-e)/(t-1);return Math.max(0,Math.min(n,1))}function $n(e){const t=G(e==null?void 0:e.rankingPosition),n=G(e==null?void 0:e.rankingOutOf),a=bn(t,n);return typeof t=="number"?{display:String(t),secondary:typeof n=="number"?`of ${n}`:"",progress:a}:{display:"—",secondary:"",progress:0}}function vn(e,t){const n=Ne(e),a=e.thumbnailUrl||(n?`https://img.youtube.com/vi/${n}/hqdefault.jpg`:W),r=e.thumbnailAlt||e.title||"Video highlight",i=e.title||"Video highlight",l=!!n?"":' disabled aria-disabled="true"',d=He(e,{variant:"card"}),c=fn(e.eventDate),u=c?Pe(c):"",f=ae(e),h=B(e.thumbnailFocalPoint||e.thumbnailHotspot),g=h?` style="object-position: ${y(h)};"`:"";return`
  ...
  `,e.addEventListener("click",t=>{t.target.closest("[data-overlay-close]")&&ge()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("is-open")&&ge()}),document.body.appendChild(e),_=e,e}function Ln(e,t){const n=kn(),a=n.querySelector(".video-overlay-frame");if(!a)return;a.innerHTML="";const r=document.createElement("iframe");r.setAttribute("src",`https://www.youtube.com/embed/${e}?autoplay=1&rel=0&modestbranding=1`),r.setAttribute("title",t),r.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"),r.setAttribute("allowfullscreen",""),r.loading="lazy",a.appendChild(r),n.classList.add("is-open"),n.setAttribute("aria-hidden","false"),document.body.classList.add("is-showing-video")}function ge(){if(!_)return;const e=_.querySelector(".video-overlay-frame");e&&(e.innerHTML=""),_.classList.remove("is-open"),_.setAttribute("aria-hidden","true"),document.body.classList.remove("is-showing-video")}let D=null;function De(e=document){if(!e)return;(e instanceof Element?e:document).querySelectorAll("[data-photo-preview]").forEach(n=>{n.dataset.photoPreviewReady!=="true"&&(n.addEventListener("click",a=>{a.target.closest(".tournament-chip")||An(n.getAttribute("data-photo-src"),n.getAttribute("data-photo-alt"),n.getAttribute("data-photo-title"))}),n.dataset.photoPreviewReady="true")})}function Tn(){if(D)return D;const e=document.createElement("div");return e.className="photo-overlay",e.setAttribute("aria-hidden","true"),e.innerHTML=`
