...
`}return e.escapeHTML(c.text)}function d(c,u,f){const m=e.types[c._type];return m||t(we(c._type),{nodeType:"block",type:c._type}),(m||e.unknownType)({value:c,isInline:f,index:u,renderNode:n})}return n};function ue(e){const{node:t,index:n,isInline:a,renderNode:r}=e,i=qe(t).map((o,l)=>r({node:o,isInline:!0,index:l,renderNode:r}));return{_key:t._key||`block-${n}`,children:i.join(""),index:n,isInline:a,node:t}}function gt(){}const z="images/samuel-placeholder.svg",Me=z,V=/^[a-zA-Z0-9_-]{11}$/,v={heroCopy:'[data-template="hero-copy"]',heroPhoto:'[data-template="hero-photo"]',accoladesMarquee:'[data-template="accolades-marquee"]',workInterstitial:'[data-template="work-interstitial"]',workMindset:'[data-template="work-mindset"]',coachSnapshot:'[data-template="coach-snapshot"]',aboutHeading:'[data-template="about-heading"]',aboutGrid:'[data-template="about-grid"]',resumeHeading:'[data-template="resume-heading"]',resumePanels:'[data-template="resume-panels"]',academicsHeading:'[data-template="academics-heading"]',academicsGrid:'[data-template="academics-grid"]',highlightsHeading:'[data-template="highlights-heading"]',highlightsTimeline:'[data-template="timeline"]',upcomingHeading:'[data-template="upcoming-heading"]',upcomingGrid:'[data-template="upcoming-grid"]',videosHeading:'[data-template="videos-heading"]',videoGrid:'[data-template="video-grid"]',videosActions:'[data-template="videos-actions"]',galleryHeading:'[data-template="gallery-heading"]',galleryGrid:'[data-template="gallery-grid"]',galleryActions:'[data-template="gallery-actions"]',dualHeading:'[data-template="dual-heading"]',dualGrid:'[data-template="dual-grid"]',contactHeading:'[data-template="contact-heading"]',contactGrid:'[data-template="contact-grid"]',highlightsActions:'[data-template="highlights-actions"]'},E={meta:null,allItems:[],items:[],videos:[],photos:[]},q={meta:null,items:[],totalCount:0},G={meta:null,items:[]};document.addEventListener("DOMContentLoaded",async()=>{mt(),Mn();const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;await ht(),window.location.hash&&setTimeout(()=>Ne(window.location.hash),100),Bn(e),On(e),Nn()});function mt(){const e=document.querySelector(".nav-toggle"),t=document.querySelector(".nav-links");!e||!t||(e.addEventListener("click",()=>{const n=e.getAttribute("aria-expanded")==="true"?"false":"true";e.setAttribute("aria-expanded",n),t.classList.toggle("is-open")}),t.querySelectorAll("a").forEach(n=>{n.addEventListener("click",()=>{e.setAttribute("aria-expanded","false"),t.classList.remove("is-open")})}))}async function ht(){Q(!0);const e=await _e();if(!e)return wn("Unable to load the latest content. Please try again shortly."),Q(!1),null;pt(e.site),yt(e.hero,e.site),bt(e.resume,e.hero),At(e.coachSnapshot,{hero:e.hero,about:e.about}),wt(e.about,{academics:e.academics}),kt(e.about,e.highlightEvents),Mt(e.resume),_t(e.academics);const t=X(e.highlightEvents||[]),{past:n,future:a}=Dn(t);E.meta=e.highlightsSection,E.allItems=n,E.items=n.filter(J),jt();const r=Array.isArray(e.upcomingTournaments)?e.upcomingTournaments:[],i=xn(r,a);Et(e.upcomingTournamentsSection,i);const o=X(e.videos||[],"eventDate");E.videos=o,q.meta=e.videosSection,q.items=o.filter(J),q.totalCount=o.length,Ut();const l=X(e.galleryPhotos||[],"shotDate");return E.photos=l,G.meta=e.gallerySection,G.items=l.filter(J),qt(),Yt(e.dualSport),Vt(e.contact),Ft(e.footer,e.contact),Q(!1),se(),e}function pt(e){var a;if(!e)return;if(e.siteTitle){document.title=e.siteTitle;const r=document.querySelector(".brand-text");r&&(r.textContent=e.siteTitle)}const t=document.querySelector('meta[name="description"]');t&&e.seoDescription&&t.setAttribute("content",e.seoDescription);const n=document.querySelector(".brand-mark");if(n)if((a=e.brandMarkImage)!=null&&a.url){const r=B(e.brandMarkImage.focalPoint||e.brandMarkImage.hotspot),i=r?` style="object-position: ${y(r)};"`:"";n.innerHTML=`<span class="brand-mark-image"><img src="${y(e.brandMarkImage.url)}" alt="${s(e.brandMarkImage.alt||e.siteTitle||"Site logo")}" loading="lazy"${i} /></span>`,n.classList.add("has-image")}else{const r=e.brandMarkInitials||Cn(e.siteTitle)||n.textContent||"SM";n.textContent=r,n.classList.remove("has-image")}}function yt(e,t){var r,i,o,l;const n=k(v.heroCopy),a=k(v.heroPhoto);if(!e){n&&(n.innerHTML=C("Hero content coming soon."));return}if(n){const d=e.tagline?`<p class="hero-tag">${s(e.tagline)}</p>`:"",c=e.bio?`<p>${s(e.bio)}</p>`:"",u=[pe(e.primaryCta,"primary","View Highlights","#highlights"),pe(null,"ghost","Schedule a Conversation","#contact")].filter(Boolean).join(""),f=Array.isArray(e.metrics)?e.metrics.filter(g=>g&&(g.label||g.value)).map(g=>{const b=g.value||"",h=String(b).trim().match(/^(-?\d+(?:\.\d+)?)(.*)$/);return`
    ...
    `}if(a){const d=((r=e.headshot)==null?void 0:r.url)||z,c=((i=e.headshot)==null?void 0:i.alt)||"Portrait of Samuel Masco",u=B(((o=e.headshot)==null?void 0:o.focalPoint)||((l=e.headshot)==null?void 0:l.hotspot)),f=u?` style="object-position: ${y(u)};"`:"";a.innerHTML=`
  ...
  `}}function Lt(e){if(typeof e!="string")return null;const t=e.match(/^\s*(\d+(?:\.\d+)?)/);return t?t[1]:null}function Tt(e){if(typeof e!="string")return null;const t=e.trim(),n=t.match(/^\s*(\d+)\s*[-–—]\s*(\d+)/);if(n)return`${n[1]}–${n[2]}`;const a=t.match(/^\s*(\d+)/);return a?a[1]:null}function At(e,t={}){const n=k(v.coachSnapshot);if(!n)return;if(!(e&&[e.gpaWeighted,e.satScore,e.actScore,e.ncaaId,e.ncaaStatus,e.transcriptUrl,e.parentName,e.parentEmail,e.parentPhone,e.clubCoachName,e.clubCoachEmail,e.clubCoachPhone,e.hsCoachName,e.hsCoachEmail,e.hsCoachPhone].some(T=>typeof T=="string"&&T.trim()!==""))){n.hidden=!0,n.innerHTML="";return}const r=t.about||{},i=Array.isArray(r.profileFacts)?r.profileFacts:[],o=T=>{var w;return((w=i.find($=>($==null?void 0:$.label)&&T.test($.label)))==null?void 0:w.value)||""},l=o(/graduat/i),d=(e==null?void 0:e.classYear)||(l?`Class of ${l}`:""),c={eyebrow:(e==null?void 0:e.eyebrow)||"Coach Snapshot",heading:(e==null?void 0:e.heading)||"The 30-second read",subheading:(e==null?void 0:e.subheading)||"",classYear:d,gpaWeighted:(e==null?void 0:e.gpaWeighted)||"",sat:(e==null?void 0:e.satScore)||"",act:(e==null?void 0:e.actScore)||"",ncaaId:(e==null?void 0:e.ncaaId)||"",ncaaStatus:(e==null?void 0:e.ncaaStatus)||"",transcriptLabel:(e==null?void 0:e.transcriptLabel)||"Download transcript",transcriptUrl:(e==null?void 0:e.transcriptUrl)||"",parentName:(e==null?void 0:e.parentName)||"",parentRole:(e==null?void 0:e.parentRole)||"",parentEmail:(e==null?void 0:e.parentEmail)||"",parentPhone:(e==null?void 0:e.parentPhone)||"",clubCoachName:(e==null?void 0:e.clubCoachName)||o(/private\s*coach|club\s*coach/i),clubCoachOrg:(e==null?void 0:e.clubCoachOrg)||"",clubCoachEmail:(e==null?void 0:e.clubCoachEmail)||"",clubCoachPhone:(e==null?void 0:e.clubCoachPhone)||"",hsCoachName:(e==null?void 0:e.hsCoachName)||"",hsCoachEmail:(e==null?void 0:e.hsCoachEmail)||"",hsCoachPhone:(e==null?void 0:e.hsCoachPhone)||"",verifiedAt:(e==null?void 0:e.verifiedAt)||o(/verified/i)},u=(T,w,$=!1)=>{if(!w)return"";const S=$?"coach-snapshot-fact-value coach-snapshot-fact-value--mono":"coach-snapshot-fact-value";return`
    ...
    `},f=(T,w,$,S)=>{if(!T&&!$&&!S)return"";const P=w?`<span class="coach-snapshot-contact-role">${s(w)}</span>`:"",H=$?`<a href="tel:${y($.replace(/[^0-9+]/g,""))}">${s($)}</a>`:"",D=S?`<a href="mailto:${y(S)}">${s(S)}</a>`:"",j=[H,D].filter(Boolean).join('<span class="coach-snapshot-contact-divider" aria-hidden="true">·</span>');return`
    ...
    `},m=[u("Class",c.classYear),u("GPA (W)",c.gpaWeighted,!0),u("SAT",c.sat,!0),u("ACT",c.act,!0)].filter(Boolean).join(""),g=[u("NCAA ID",c.ncaaId,!0),u("NCAA Status",c.ncaaStatus),u("Verified",St(c.verifiedAt))].filter(Boolean).join(""),b=c.transcriptUrl?`<a class="btn subtle coach-snapshot-transcript" href="${y(c.transcriptUrl)}" target="_blank" rel="noopener">${s(c.transcriptLabel)}</a>`:"",h=[f(c.parentName,c.parentRole||"Parent / Guardian",c.parentPhone,c.parentEmail),f(c.clubCoachName,c.clubCoachOrg||"Private Coach",c.clubCoachPhone,c.clubCoachEmail),f(c.hsCoachName,"HS Coach",c.hsCoachPhone,c.hsCoachEmail)].filter(Boolean).join(""),L=[m?{title:"By the numbers",body:m}:null,g||b?{title:"Eligibility",body:`${g}${b?`<div class="coach-snapshot-transcript-wrap">${b}</div>`:""}`}:null,h?{title:"Recruiting contacts",body:h}:null].filter(Boolean);if(!L.length){n.hidden=!0;return}const p=`<p class="section-kicker">${s(c.eyebrow)}</p>`,A=`<h2 class="coach-snapshot-heading">${s(c.heading)}</h2>`,M=c.subheading?`<p class="coach-snapshot-subheading">${s(c.subheading)}</p>`:"";n.hidden=!1,n.innerHTML=`
  ...
  `;let l="";if(r){const d=[{label:"School",value:r.schoolCardTitle},{label:"GPA",value:r.gpa},{label:"Honors / AP",value:r.honors},{label:"AP / IB Status",value:r.apCourses}].filter(m=>m.value),c=d.length?`
        ...
        `:"",u=r.interestsBody?`<div class="about-academics-interests">${K(r.interestsBody)}</div>`:"",f=r.transcriptUrl?`<a class="btn subtle" href="${y(r.transcriptUrl)}" target="_blank" rel="noopener">${s(r.transcriptLabel||"Transcript")}</a>`:"";(c||u||f)&&(l=`
  ...
  `}function Mt(e){const t=k(v.resumeHeading),n=k(v.resumePanels);if(t&&(t.innerHTML=e?`
          ...
          <p>${s(e.subheading||"")}</p>
        `:C("Golf resume coming soon.")),n){if(!e){n.innerHTML=C("Resume details coming soon.");return}const a=/^(handicap|gpa)$/i,r=Array.isArray(e.performanceStats)?e.performanceStats:[],i=[],o=[];r.forEach(g=>{Ht(g)?i.push(...Ot(g==null?void 0:g.value)):a.test(((g==null?void 0:g.label)||"").trim())||o.push(g)});const l=Array.isArray(e.clubYardages)?e.clubYardages:[],d=l.length?l:i,c=d.length>0,u=e.clubYardagesTitle||"Club Yardages",f=c?`
          <div class="performance-clubs">
            <h4 class="performance-section-title">${s(u)}</h4>
            ${Nt(d)}
          </div>
        `:"",m=o.map(g=>{const b=g.value||"",h=String(b).trim().match(/^(-?\d+(?:\.\d+)?)(.*)$/),L=h?` data-counter="${y(h[1])}" data-counter-suffix="${y(h[2]||"")}"`:"";return`
          <div class="performance-stat">
            <span class="performance-stat-label">${s(g.label||"")}</span>
      ...
      <article class="panel" data-motion="delay-3">
        ...
        <ul>
          ${(e.experienceList||[]).map(g=>`<li>${s(g||"")}</li>`).join("")}
        </ul>
      </article>
      ${Ct(e)}
  ...
  `}function Ot(e){return!e||typeof e!="string"?[]:e.split(/[,\n;]/).map(t=>t.trim()).filter(Boolean).map(t=>{const n=t.indexOf(":");if(n>-1)return{club:t.slice(0,n).trim(),yardage:t.slice(n+1).trim()};const a=t.match(/^(.*?)\s+(\d[\d,]*)(\s*(?:yds?|yards?)?)\s*$/i);return a?{club:a[1].trim(),yardage:`${a[2]}${a[3]?a[3].trim():""}`}:{club:t,yardage:""}}).filter(t=>t.club)}function _t(e){const t=k(v.academicsHeading),n=k(v.academicsGrid);if(t&&(t.innerHTML=e?`
    ...
    `}}function jt(){const e=E.meta,t=E.items||[],n=k(v.highlightsHeading),a=k(v.highlightsTimeline),r=k(v.highlightsActions);if(n&&(n.innerHTML=e?`
          ...
          <p>${s(e.subheading||"")}</p>
        `:C("Highlights coming soon.")),!a)return;const i=(e==null?void 0:e.maxItems)||5,o=t.slice(0,i);if(!o.length){a.innerHTML=C("Highlight events coming soon."),r&&(r.innerHTML="");return}a.innerHTML=o.map((l,d)=>Wt(l,d)).join(""),a.querySelectorAll("[data-motion]").forEach(l=>l.classList.add("is-visible")),ie(a),r&&(r.innerHTML=`
    ...
    `)}function Ut(){const e=q.meta,t=q.items||[],n=k(v.videosHeading),a=k(v.videoGrid),r=k(v.videosActions);if(n&&(n.innerHTML=e?`
          ...
          <p>${s(e.subheading||"")}</p>
        `:C("Videos coming soon.")),!a)return;const i=(e==null?void 0:e.maxItems)||3,o=t.slice(0,i);if(!o.length){a.innerHTML=C("Video highlights coming soon."),r&&(r.innerHTML="");return}a.innerHTML=o.map((l,d)=>kn(l,d)).join(""),a.querySelectorAll("[data-motion]").forEach(l=>l.classList.add("is-visible")),se(),ie(a),r&&(r.innerHTML=`
    ...
    `)}function qt(){const e=G.meta,t=G.items||[],n=k(v.galleryHeading),a=k(v.galleryGrid),r=k(v.galleryActions);if(n){const l=(e==null?void 0:e.heading)||"Photo Gallery",d=(e==null?void 0:e.subheading)||"Tournament action and behind-the-scenes moments.";n.innerHTML=`
      <h2>${s(l)}</h2>
      ${`<p>${s(d)}</p>`}
    `}if(!a)return;const i=Math.max(1,(e==null?void 0:e.maxItems)||6),o=t.slice(0,i);if(!o.length){a.innerHTML=C("Gallery photos coming soon."),r&&(r.innerHTML="");return}if(a.innerHTML=o.map((l,d)=>Rt(l,d)).join(""),a.querySelectorAll("[data-motion]").forEach(l=>l.classList.add("is-visible")),Be(a),ie(a),r){const l="gallery.html",d=(e==null?void 0:e.ctaLabel)||"Explore the full gallery";r.innerHTML=`<a class="btn ghost" href="${y(l)}">${s(d)}</a>`}}function Rt(e,t=0){var A,M,T,w,$;const n=((A=e==null?void 0:e.image)==null?void 0:A.url)||z,a=((M=e==null?void 0:e.image)==null?void 0:M.alt)||(e==null?void 0:e.title)||"Gallery highlight",r=He(e,{variant:"card"}),i=Hn(e==null?void 0:e.shotDate),o=i?De(i):"",l=(T=e==null?void 0:e.image)!=null&&T.url?{src:n,alt:a,title:(e==null?void 0:e.title)||"Gallery highlight"}:null,d=l?`data-photo-src="${y(l.src)}" data-photo-alt="${y(l.alt)}" data-photo-title="${y(l.title)}"`:"",c=[];e!=null&&e.location&&c.push(e.location);const u=c.map(S=>`<span>${s(S)}</span>`).join('<span class="meta-dot" aria-hidden="true">•</span>'),f=u?`<div class="gallery-card-meta">${u}</div>`:"",m=e!=null&&e.description?`<p class="gallery-card-description">${s(e.description)}</p>`:"",g=e!=null&&e.photographer?`<div class="gallery-card-meta gallery-card-meta--secondary">Photo: ${s(e.photographer)}</div>`:"",b=g?`<div class="gallery-card-footer">${g}</div>`:"",h=l?`data-photo-preview="true" ${d}`:"",L=B(((w=e==null?void 0:e.image)==null?void 0:w.focalPoint)||(($=e==null?void 0:e.image)==null?void 0:$.hotspot)),p=L?` style="object-position: ${y(L)};"`:"";return`
  ...
  `:""}function Yt(e){const t=k(v.dualHeading),n=k(v.dualGrid);if(t&&(t.innerHTML=e?`
        ...
        `}).join("")}}function Vt(e){const t=k(v.contactHeading),n=k(v.contactGrid);if(t&&(t.innerHTML=e?`
  ...
  `}function Gt(e){var r;if(!e)return"";const t=e.label?`<strong>${s(e.label)}:</strong> `:"",n=En(e.value),a=(r=e.link)!=null&&r.startsWith("http")?' target="_blank" rel="noopener"':"";return e.link&&n.length<=1?`${t}<a href="${y(e.link)}"${a}>${s(e.value||e.link)}</a>`:n.length?`${t}${n.map((i,o)=>{const l=o===0&&e.link?e.link:i.link;if(l){const c=l.startsWith("http")?' target="_blank" rel="noopener"':"";return`<a href="${y(l)}"${c}>${s(i.text)}</a>`}return s(i.text)}).join(" · ")}`:`${t}${s(e.value||"")}`}function Wt(e,t){var j,oe;const n=Pn(e),a=e.summary?`<p class="case-study-summary">${s(e.summary)}</p>`:"",r=Array.isArray(e.days)?e.days:[],i=`home-highlight-${t}`,o=(e==null?void 0:e._id)||(e==null?void 0:e.title)||i,l=(j=e==null?void 0:e.coverImage)!=null&&j.url?e.coverImage:null,c=(oe=Ee(e)[0])==null?void 0:oe.image,u=l||c,f=(u==null?void 0:u.url)||"",m=(u==null?void 0:u.alt)||(e==null?void 0:e.title)||"Tournament photo",g=B((u==null?void 0:u.focalPoint)||(u==null?void 0:u.hotspot)),b=g?` style="object-position: ${y(g)};"`:"",h=Kt(r),L=(h==null?void 0:h.score)!=null?String(h.score):"",p=[...r].reverse().find(_=>(_==null?void 0:_.rankingPosition)!=null||((_==null?void 0:_.rankingLabel)||"").trim()!==""),A=p?p.rankingPosition!=null?`${p.rankingPosition}${p.rankingOutOf!=null?` / ${p.rankingOutOf}`:""}`:p.rankingLabel.trim():"",M=(h==null?void 0:h.yardage)!=null&&(h==null?void 0:h.yardage)!==""?String(h.yardage):"",T=e!=null&&e.location?String(e.location):"",w=!!(e!=null&&e.pinToTop||e!=null&&e.featured),$=`
  ...
  `,S=[];A&&S.push(`<div class="case-study-chip case-study-chip--finish"><span class="case-study-chip-label">Finish</span><span class="case-study-chip-value">${s(A)}</span></div>`),M&&S.push(`<div class="case-study-chip"><span class="case-study-chip-label">Yardage</span><span class="case-study-chip-value">${s(M)}</span></div>`),r.length>1&&S.push(`<div class="case-study-chip"><span class="case-study-chip-label">Rounds</span><span class="case-study-chip-value">${r.length}</span></div>`);const P=S.length?`<div class="case-study-chips">${S.join("")}</div>`:"",H=f?`
        <img
          ...
          ${b}
        />
      `:zt(e),D=String(t+1).padStart(2,"0");return`
  ...
  `}function zt(e){const t=((e==null?void 0:e.title)||"").trim(),n=t.indexOf("@"),a=n>0?t.slice(0,n).trim().replace(/[:\-–]\s*$/,""):"",r=n>=0?t.slice(n+1).trim():t,i=l=>{const d=(l||"").match(/\bin\s+([A-Za-z .'-]+,\s*[A-Za-z]{2})\s*$/);return d?d[1].replace(/\s+/g," "):""},o=i(e==null?void 0:e.location)||i(e==null?void 0:e.summary);return`
  ...
  `}function Kt(e){if(!Array.isArray(e)||!e.length)return null;const t=e.map(n=>{const a=Number(n==null?void 0:n.score);return Number.isFinite(a)?{day:n,numeric:a}:null}).filter(Boolean);return t.length?(t.sort((n,a)=>n.numeric-a.numeric),t[0].day):e[0]}function Zt(e=[],{variant:t="default",showLabels:n}={}){if(!Array.isArray(e)||!e.length)return"";const a=e.length,r=typeof n=="boolean"?n:a>1;return`
    <div class="${["day-stats",t==="compact"?"day-stats--compact":"",t==="list"?"day-stats--list":"",a===1?"day-stats--single":"",`day-stats--cols-${Math.min(a,3)}`].filter(Boolean).join(" ")}">
      ${e.map((o,l)=>Xt(o,l,{showLabels:r,total:a})).join("")}
    </div>
  `}const fe=120,Qt=57;function Xt(e,t,{showLabels:n,total:a}){if(!e)return"";const r=a===1,i=!r&&n?xe(e,t,a):null,o=Jt(e);return o?`
    <div class="day-stat${r?" day-stat--single":""}">
      ${i?`<span class="day-stat-label">${s(i)}</span>`:""}
      ${o}
    </div>
  `:""}function Jt(e){const t=hn(e);return t.length?`
  ...
  `}function sn(e){return!Array.isArray(e)||!e.length?'<p class="placeholder-text">No videos linked to this tournament yet.</p>':`
    <div class="overlay-media-grid">
      ${e.map(ln).join("")}
    </div>
  `}function ln(e){const t=Oe(e),n=e.thumbnailUrl||(t?`https://img.youtube.com/vi/${t}/hqdefault.jpg`:Me),a=e.thumbnailAlt||e.title||"Video highlight",r=e.title||"Video highlight",o=!!t?"":' disabled aria-disabled="true"',l=re?re(e):"",d=B(e.thumbnailFocalPoint||e.thumbnailHotspot),c=d?` style="object-position: ${y(d)};"`:"";return`
  ...
  `}function on(e){return!Array.isArray(e)||!e.length?'<p class="placeholder-text">No photos linked to this tournament yet.</p>':`
    <div class="overlay-media-grid overlay-photo-grid">
      ${e.map(cn).join("")}
    </div>
  `}function cn(e){var d,c,u,f,m;const t=((d=e==null?void 0:e.image)==null?void 0:d.url)||Me,n=((c=e==null?void 0:e.image)==null?void 0:c.alt)||(e==null?void 0:e.title)||"Gallery photo",a=(u=e==null?void 0:e.image)!=null&&u.url?{src:t,alt:n,title:(e==null?void 0:e.title)||"Gallery photo"}:null,r=a?`data-photo-preview="true" data-photo-src="${y(a.src)}" data-photo-alt="${y(a.alt)}" data-photo-title="${y(a.title)}"`:"",i=e!=null&&e.photographer?`<div class="gallery-card-meta gallery-card-meta--secondary">Photo: ${s(e.photographer)}</div>`:"",o=B(((f=e==null?void 0:e.image)==null?void 0:f.focalPoint)||((m=e==null?void 0:e.image)==null?void 0:m.hotspot)),l=o?` style="object-position: ${y(o)};"`:"";return`
  ...
  `}function dn(e){return!e||!Array.isArray(E.videos)?[]:E.videos.filter(t=>Ie(t,e))}function Ee(e){return!e||!Array.isArray(E.photos)?[]:E.photos.filter(t=>Ie(t,e))}function Ie(e,t){const n=Pe(e);return n?!!(n.id&&(t!=null&&t._id)&&n.id===t._id||n.title&&(t!=null&&t.title)&&n.title===t.title):!1}function Pe(e){return e?e.tournament&&typeof e.tournament=="object"&&e.tournament.title?{id:e.tournament._id||e.tournament._ref||e.tournament.id||null,title:e.tournament.title}:typeof e.tournament=="string"&&e.tournament?{id:e.tournament,title:e.tournament}:null:null}function un(e){return!e||!Array.isArray(e.tags)?[]:e.tags.map(t=>typeof t=="string"?t.trim():"").filter(Boolean)}function re(e){const t=un(e);return t.length?`
    <div class="gallery-card-tags video-card-tags">
      ${t.map(n=>`<span class="gallery-tag">${s(n)}</span>`).join("")}
    </div>
  `:""}function fn(e){const t=Pe(e);if(!t||!t.title)return null;const n=t.id||t.title,a=n?Ce(n):null,r=a?a._id||a.title:null;return{label:(a==null?void 0:a.title)||t.title,targetId:r}}function He(e,{variant:t="inline"}={}){const n=fn(e);if(!(n!=null&&n.label))return"";const a=["tournament-chip"];t==="card"&&a.push("tournament-chip--on-card"),t==="inline"&&a.push("tournament-chip--inline");const r=s(n.label),i=y(`View ${n.label} tournament details`),o=n.targetId?` data-highlight-modal="${y(n.targetId)}"`:"",l=n.targetId?`tournament-highlights.html?tournament=${encodeURIComponent(n.targetId)}`:"tournament-highlights.html",d="a";return`
    <${d} class="${a.join(" ")}" href="${y(l)}"${o}${n.targetId?` aria-label="${i}"`:""}>
      <span class="tournament-chip-name">${r}</span>
    </${d}>
  `}function gn(e){if(!e)return null;const t=I(e);return t?{month:t.toLocaleString("en-US",{month:"short"}),day:t.getDate().toString().padStart(2,"0"),year:t.getFullYear()}:null}function De(e){return`
    <div class="video-date-overlay" aria-label="${e.month} ${e.day}, ${e.year}">
      <span class="month">${e.month}</span>
      <strong>${e.day}</strong>
      <span class="year">${e.year}</span>
    </div>
  `}function mn(e){return e?le(e.eventDate,e.endDate,{month:"long"}):""}function hn(e){if(!e)return[];const t=[],n=W(e.score),a=W(e.yardage);t.push(Z({key:"score",label:"Score",display:typeof n=="number"?String(n):"—",progress:yn(n)})),t.push(Z({key:"yards",label:"Yardage",display:typeof a=="number"?a.toLocaleString():"—",secondary:"",progress:bn(a,pn(e,a))}));const r=vn(e);return t.push(Z({key:"rank",label:"Rank",display:r.display,secondary:r.secondary,progress:r.progress})),t.filter(Boolean)}function Z({key:e,label:t,display:n,secondary:a,progress:r}){const i=n!=null&&n!==""?String(n):"—",o=a?String(a):"",l=typeof r=="number"&&!Number.isNaN(r)?r:0;return{key:e,label:t,display:i,secondary:o,progress:Math.max(0,l)}}function xe(e,t,n){return e.label?e.label:n>1?`Day ${t+1}`:null}function W(e){return typeof e=="number"&&!Number.isNaN(e)?e:null}function pn(e,t){return typeof t=="number"&&t>0?Math.max(7200,Math.round(t/50)*50):7200}function yn(e){if(typeof e!="number"||Number.isNaN(e))return 0;const t=fe-Qt;return(fe-e)/t}function bn(e,t){return typeof e!="number"||Number.isNaN(e)||!t||t<=0?0:e/t}function $n(e,t){if(typeof e!="number"||Number.isNaN(e)||typeof t!="number"||t<=0)return 0;if(t===1)return 1;const n=(t-e)/(t-1);return Math.max(0,Math.min(n,1))}function vn(e){const t=W(e==null?void 0:e.rankingPosition),n=W(e==null?void 0:e.rankingOutOf),a=$n(t,n);return typeof t=="number"?{display:String(t),secondary:typeof n=="number"?`of ${n}`:"",progress:a}:{display:"—",secondary:"",progress:0}}function kn(e,t){const n=Oe(e),a=e.thumbnailUrl||(n?`https://img.youtube.com/vi/${n}/hqdefault.jpg`:z),r=e.thumbnailAlt||e.title||"Video highlight",i=e.title||"Video highlight",l=!!n?"":' disabled aria-disabled="true"',d=He(e,{variant:"card"}),c=gn(e.eventDate),u=c?De(c):"",f=re(e),m=B(e.thumbnailFocalPoint||e.thumbnailHotspot),g=m?` style="object-position: ${y(m)};"`:"";return`
    <article class="video-gallery-card" data-motion="delay-${t+1}">
      <div class="video-frame" data-video-id="${s(n)}" data-video-title="${s(i)}">
        ${u}
        <img src="${y(a)}" alt="${s(r)}" loading="lazy"${g} />
  ...
  `,e.addEventListener("click",t=>{t.target.closest("[data-photo-overlay-close]")&&he()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("is-open")&&he()}),document.body.appendChild(e),x=e,e}function Sn(e,t,n){if(!e)return;const a=An(),r=a.querySelector("img"),i=a.querySelector("figcaption");!r||!i||(r.src=e,r.alt=t||n||"Gallery photo",i.textContent=n||t||"",a.classList.add("is-open"),a.setAttribute("aria-hidden","false"),document.body.classList.add("is-showing-photo"))}function he(){if(!x)return;const e=x.querySelector("img"),t=x.querySelector("figcaption");e&&(e.src="",e.alt=""),t&&(t.textContent=""),x.classList.remove("is-open"),x.setAttribute("aria-hidden","true"),document.body.classList.remove("is-showing-photo")}function K(e){return!Array.isArray(e)||!e.length?"":ut(e)}function k(e){return e?document.querySelector(e):null}function C(e){return`<p class="placeholder-text">${s(e)}</p>`}function Q(e){document.body.dataset.contentLoading=String(e)}function wn(e){const t=document.querySelector("main");t&&t.insertAdjacentHTML("afterbegin",`<div class="notification error">${s(e)}</div>`)}function pe(e,t,n,a){const r=(e==null?void 0:e.label)||n,i=(e==null?void 0:e.href)||a;if(!r||!i)return"";const l=i.startsWith("#")?' data-scroll="true"':' target="_blank" rel="noopener"';return`<a class="btn ${t}" href="${y(i)}"${l}>${s(r)}</a>`}function Mn(){document.addEventListener("click",e=>{const t=e.target.closest('a[data-scroll="true"]');if(!t)return;const n=t.getAttribute("href")||"";Ne(n)&&e.preventDefault()})}function Ne(e){if(!e||!e.startsWith("#")||e.length===1)return!1;const t=document.querySelector(e);return t?(t.scrollIntoView({behavior:"smooth",block:"start"}),!0):!1}function le(e,t,{month:n="short"}={}){if(!e)return"";const a=I(e);if(!a)return s(e);if(!t)return a.toLocaleDateString("en-US",{month:n,day:"numeric",year:"numeric"});const r=I(t);if(!r)return`${a.toLocaleDateString("en-US",{month:n,day:"numeric",year:"numeric"})} – ${s(t)}`;const i=a.getFullYear()===r.getFullYear(),o=i&&a.getMonth()===r.getMonth();if(i&&o)return`${a.toLocaleDateString("en-US",{month:n})} ${a.getDate()}–${r.getDate()}, ${a.getFullYear()}`;if(i){const c=a.toLocaleDateString("en-US",{month:n,day:"numeric"}),u=r.toLocaleDateString("en-US",{month:n,day:"numeric"});return`${c} – ${u}, ${a.getFullYear()}`}const l=a.toLocaleDateString("en-US",{month:n,day:"numeric",year:"numeric"}),d=r.toLocaleDateString("en-US",{month:n,day:"numeric",year:"numeric"});return`${l} – ${d}`}function Oe(e){return e?ye(e.youtubeId)||ye(e.youtubeUrl):""}function ye(e){if(!e)return"";const t=String(e).trim();if(!t)return"";if(V.test(t))return t;let n;try{n=new URL(t)}catch{try{n=new URL(`https://${t}`)}catch{return""}}const a=n.hostname.replace(/^www\./,"").toLowerCase();if(a==="youtu.be"){const r=n.pathname.split("/").filter(Boolean)[0];return r&&V.test(r)?r:""}if(a==="youtube.com"||a.endsWith(".youtube.com")){const r=n.searchParams.get("v");if(r&&V.test(r))return r;const i=n.pathname.split("/").filter(Boolean);if(i.length>=2&&(i[0]==="embed"||i[0]==="shorts")){const o=i[1];return o&&V.test(o)?o:""}}return""}function s(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function y(e){return s(e)}function B(e){if(!e||typeof e.x!="number"||typeof e.y!="number")return"";const t=r=>Math.max(0,Math.min(1,r)),n=Math.round(t(e.x)*1e3)/10,a=Math.round(t(e.y)*1e3)/10;return`${n}% ${a}%`}function Cn(e){if(!e)return"";const t=e.trim().split(/\s+/).filter(Boolean);return t.length?t.slice(0,2).map(n=>n.charAt(0).toUpperCase()).join(""):""}function En(e){if(!e)return[];const t=String(e).trim();return t?t.replace(/\s[-–—]\s/g,"|").split(/·|\|/g).map(r=>r.trim()).filter(Boolean).map(r=>({text:r,link:In(r)})):[]}function In(e){if(!e)return null;const t=e.replace(/\s+/g,"");return/^\(?\+?\d[\d\-()\s\.]+$/.test(e)?`tel:${t.replace(/[^\d+]/g,"")}`:/^[\w.+-]+@[\w.-]+\.[A-Za-z]{2,}$/.test(e)?`mailto:${t}`:null}function Pn(e){return e?le(e.eventDate,e.endDate,{month:"short"}):""}function Hn(e){if(!e)return null;const t=I(e);return t?{month:t.toLocaleString("en-US",{month:"short"}),day:t.getDate().toString().padStart(2,"0"),year:t.getFullYear()}:null}function X(e,t="eventDate"){return Array.isArray(e)?[...e].sort((n,a)=>be(a,t)-be(n,t)):[]}function be(e,t){if(!e)return 0;const n=e[t],a=I(n);if(a)return a.getTime();const r=I(e._createdAt);return r?r.getTime():0}function J(e){return e?typeof e.showOnHomePage=="boolean"?e.showOnHomePage:typeof e.featured=="boolean"?e.featured:typeof e.pinToTop=="boolean"?e.pinToTop:!0:!1}function Dn(e){const t=[],n=[];if(!Array.isArray(e))return{past:t,future:n};const a=new Date,r=new Date(a.getFullYear(),a.getMonth(),a.getDate()).getTime();return e.forEach(i=>{if(!i)return;const o=I(i.endDate),l=I(i.eventDate),d=o||l;d&&d.getTime()>=r?n.push(i):t.push(i)}),{past:t,future:n}}function xn(e,t){const n=new Set,a=[],r=i=>{if(!i)return;const o=i._id||i.id||`${i.course||""}|${i.eventDate||""}`;n.has(o)||(n.add(o),a.push(i))};return e.forEach(r),t.forEach(i=>{var o,l;i&&r({_id:i._id,course:i.course||i.title||i.headline||"",location:i.location||i.city||"",eventDate:i.eventDate,endDate:i.endDate,yardage:i.yardage||((l=(o=i.days)==null?void 0:o[0])==null?void 0:l.yardage)||""})}),a.sort((i,o)=>{var c,u;const l=((c=I(i==null?void 0:i.eventDate))==null?void 0:c.getTime())??Number.POSITIVE_INFINITY,d=((u=I(o==null?void 0:o.eventDate))==null?void 0:u.getTime())??Number.POSITIVE_INFINITY;return l-d}),a}function Bn(e){if(e||!("IntersectionObserver"in window)){document.querySelectorAll("[data-motion]").forEach(n=>n.classList.add("is-visible"));return}const t=new IntersectionObserver(n=>{n.forEach(a=>{a.isIntersecting&&(a.target.classList.add("is-visible"),t.unobserve(a.target))})},{threshold:.2});document.querySelectorAll("[data-motion]").forEach(n=>t.observe(n))}function Nn(){const e=Array.from(document.querySelectorAll(".scroll-panel")),t=e.findIndex(p=>p.dataset.theme==="dark");if(t<=0)return;let n=t;for(;n+1<e.length&&e[n+1].dataset.theme==="dark";)n+=1;const a=e[t-1],r=e[t],i=e[n],o=e[n+1];if(!a||!o)return;const l=window.matchMedia("(prefers-reduced-motion: reduce)").matches,d=document.body,c=document.documentElement,u=(p,A,M)=>Math.max(A,Math.min(M,p)),f=p=>u(1-3*p,0,1),m=p=>u(3*p-2,0,1);let g=-1,b=-1;const h=()=>{const p=window.innerHeight,A=a.getBoundingClientRect(),M=r.getBoundingClientRect(),T=i.getBoundingClientRect(),w=o.getBoundingClientRect(),$=M.top-A.bottom,S=w.top-T.bottom,P=u((p-A.bottom)/Math.max(1,p+$),0,1),H=u((p-T.bottom)/Math.max(1,p+S),0,1),D=P*(1-H);c.style.setProperty("--theme-t",l?D>=.5?"1":"0":D.toFixed(4)),D>=.5?d.dataset.theme!=="dark"&&(d.dataset.theme="dark"):d.dataset.theme==="dark"&&delete d.dataset.theme,l||(a.style.opacity=String(f(P)),o.style.opacity=String(m(H)),r===i?r.style.opacity=String(Math.min(m(P),f(H))):(r.style.opacity=String(m(P)),i.style.opacity=String(f(H))))},L=()=>{const p=window.scrollY,A=window.innerHeight;(p!==g||A!==b)&&(g=p,b=A,h()),requestAnimationFrame(L)};h(),requestAnimationFrame(L)}function On(e){const t=Array.from(document.querySelectorAll("[data-counter]"));if(!t.length)return;const n=l=>{const d=Number(l.getAttribute("data-counter")),c=l.getAttribute("data-counter-suffix")||"";if(!Number.isFinite(d))return;const u=ee(l.getAttribute("data-counter"));l.textContent=te(d,u)+c,l.dataset.counterDone="true"};if(e){t.forEach(n);return}t.forEach(l=>{const d=ee(l.getAttribute("data-counter"));l.textContent=te(0,d)+(l.getAttribute("data-counter-suffix")||"")});const a=l=>{if(l.dataset.counterDone==="true")return;l.dataset.counterDone="true";const d=Number(l.getAttribute("data-counter")),c=l.getAttribute("data-counter-suffix")||"";if(!Number.isFinite(d)){n(l);return}const u=ee(l.getAttribute("data-counter")),f=1200,m=Date.now(),g=setInterval(()=>{const b=Date.now()-m,h=Math.min(1,b/f),L=1-Math.pow(1-h,3),p=d*L;l.textContent=te(p,u)+c,h>=1&&(clearInterval(g),n(l))},16)},r=l=>{const d=l.getBoundingClientRect(),c=window.innerHeight||document.documentElement.clientHeight;return d.top<c*.9&&d.bottom>0},i=()=>{let l=0;return t.forEach(d=>{d.dataset.counterDone!=="true"&&(r(d)?a(d):l+=1)}),l};i();const o=()=>{i()===0&&(window.removeEventListener("scroll",o,{passive:!0}),window.removeEventListener("resize",o))};window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",o)}function ee(e){if(typeof e!="string")return 0;const t=e.indexOf(".");return t>=0?e.length-t-1:0}function te(e,t){return t>0?e.toFixed(t):String(Math.round(e))}
